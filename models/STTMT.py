...
from .layers import (make_layer, ResidualBlock_noBN, EncoderLayer, DecoderLayer,
                     InputProj, Downsample, Upsample, TFRB_encoder, TFRB_decoder)
from timm.models.layers import trunc_normal_


class STTMT(nn.Module):
    def __init__(self, in_chans=3, embed_dim=96,
                 ...
                 hid_S=96, hid_T=128, N_T=4, incep_ker=[3, 5, 7, 11], groups=8,
                 back_RBs=0, back_RBs_E=4):
        """
        ...
        self.TauE = TFRB_encoder(d_model=384, kernel_size=21, attn_shortcut=True)
        self.TauD = TFRB_decoder(d_model=672, kernel_size=21, attn_shortcut=True)
